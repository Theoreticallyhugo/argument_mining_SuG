...
class data_preparator:
    def __init__(self) -> None:
        ...
        self.__label_span_tag = ClassLabel(
            names=["MajorClaim", "Claim", "Premise"]
        )
    ...
    def get_dataset_spans(
        ...
        ds_find, _ = self.dataset_from_dict(
            data_set_find, validation_size, test_size
        )
        return (
            ds_find,
            self.__find_span_tag,
    ...
    def get_dataset_spans_labels(
        ...
        ds_label, _ = self.dataset_from_dict(
            data_set_label, validation_size, test_size
        )
    ...
    def match_sent_to_par(
        self, paragraphs: list, sentences: list, debug=False
    ):
        """
...
if __name__ == "__main__":
    ...
    data_preparator.find_paragraph(
        data_preparator.get_essay_list(
            os.path.join(os.pardir, "data", "essay.json")
        )
    )
