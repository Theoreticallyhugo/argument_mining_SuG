...
dp = data_preparator()
essays = dp.get_essay_list(
    os.path.join(os.pardir, os.pardir, "data", "essay.json")
)
# throw away the dataset and labels we dont need here

# these lines are for the switch to the full_data.py
# ds = dp.get_dataset_full(essays)
# raw_datasets, feat_ner_tags = dp.dataset_from_dict(ds, 0.2, 0.1)
raw_datasets, feat_ner_tags = dp.get_dataset_text(
    essays,
    0.2,
    0.1,
)
...
# =========================================
# get the tokenizer
model = input("choose the model to use: \n1: Bert\n2: Longformer\n> ")
if model == 1:
...
output_dir = "longformer-one-step"
